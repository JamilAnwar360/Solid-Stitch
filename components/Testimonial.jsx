    ...
    <div className='my-10 mt-10 border-t border-white'>
      <div className='text-center py-8 text-3xl'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto maiores porro perspiciatis eaque beatae accusamus quasi necessitatibus tempore eveniet debitis!
        </p>
      </div>
